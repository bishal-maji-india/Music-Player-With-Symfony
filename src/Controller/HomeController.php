...
class HomeController extends AbstractController
{
     ...
     */
    public function update_profile(EntityManagerInterface $entityManager, Request $request){

        $form=$this->createFormBuilder([])
            ->add('email',TextType::class,['label'=>'Email'])
            ->add('contact',TextType::class,['label'=>'Contact'])
            ->add('intrest',TextType::class,['label'=>'Interest'])
            ->add('update',SubmitType::class,['label'=>'Interest'])
            ->getForm();
        ...
        return $this->render('home/update_profile.html.twig', ['update_profile_form'=>$form->createView()]);
